...
namespace Prac2 {
	...
	/// <summary>
	/// —водка дл€ MyFormDelete
	/// </summary>
	public ref class MyFormDelete : public System::Windows::Forms::Form
	{
	public:
		int* last;
		int* n;
		...
		MyFormDelete(Medicine* medicines, int* last, int* n, System::Windows::Forms::DataGridView^ dataGridView1)
		{
			this->last = last;
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(MyFormDelete::typeid));
			...
			this->buttonOk->Click += gcnew System::EventHandler(this, &MyFormDelete::buttonOk_Click);
			// 
			// MyFormDelete
			// 
