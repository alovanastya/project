...
namespace Prac2 {
	...
	public:
		int* last;
		MyForm3(Medicine* medicines, int* last, System::Windows::Forms::DataGridView^ dataGridView1)
		{
			InitializeComponent();
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->buttonGraphMaker->Click += gcnew System::EventHandler(this, &MyForm3::buttonGraphMaker_Click);
			// 
			// buttonGraphCategory
			// 
			...
			this->buttonGraphCategory->Click += gcnew System::EventHandler(this, &MyForm3::buttonGraphCategory_Click);
			// 
			// buttonGraphForm
			// 
			...
			this->buttonGraphForm->Click += gcnew System::EventHandler(this, &MyForm3::buttonGraphForm_Click);
			// 
			// pictureBox1
			// 
