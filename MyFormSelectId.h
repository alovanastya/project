...
namespace Prac2 {
	...
	/// <summary>
	/// Сводка для MyFormSelectId
	/// </summary>
	public ref class MyFormSelectId : public System::Windows::Forms::Form
	{
	public:
		int* last;
		int* n;
		...
		MyFormSelectId(Medicine* medicines, int* last, int* n, System::Windows::Forms::DataGridView^ dataGridView1)//, MyForm1 f)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(MyFormSelectId::typeid));
			...
			this->buttonOk->Click += gcnew System::EventHandler(this, &MyFormSelectId::button1_Click);
			// 
			// label1
			// 
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		*n = (Convert::ToInt32(numericUpDownId->Value));
		...
		if (flag) {
			...
			MyFormEdit^ f7 = gcnew MyFormEdit(medicines, n, n1, last, dataGridView1);
			f7->Show();
			Close();
		}
	}
