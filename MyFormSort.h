...
namespace Prac2 {
	...
	/// <summary>
	/// Сводка для MyFormSort
	/// </summary>
	public ref class MyFormSort : public System::Windows::Forms::Form
	{
	public:
	...
	public:
		Medicine* medicines;
		MyFormSort(Medicine* medicines, int* last, System::Windows::Forms::DataGridView^ dataGridView1)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(MyFormSort::typeid));
			...
			this->buttonOk->Click += gcnew System::EventHandler(this, &MyFormSort::buttonOk_Click);
			// 
			// comboBoxItem
			// 
