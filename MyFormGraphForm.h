...
namespace Prac2 {
	...
	/// <summary>
	/// Сводка для MyFormGraphForm
	/// </summary>
	public ref class MyFormGraphForm : public System::Windows::Forms::Form
	{
	public:
		int* last;
		Medicine* medicines;
	...
	public:
		...
		MyFormGraphForm(Medicine* medicines, int* last, System::Windows::Forms::DataGridView^ dataGridView1)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(MyFormGraphForm::typeid));
			...
			this->buttonOk->Click += gcnew System::EventHandler(this, &MyFormGraphForm::buttonOk_Click_1);
			// 
			// MyFormGraphForm
			// 
