...
namespace Prac2 {
	...
	public:
		Medicine* medicines;
		MyFormMenu(Medicine *medicines, int *last, int* n)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->buttonGraph->Click += gcnew System::EventHandler(this, &MyFormMenu::buttonGraph_Click);
			// 
			// buttonSaveTXT
			// 
...
private: System::Void buttonAdd_Click(System::Object^ sender, System::EventArgs^ e) {
	//добавление элемента
	MyFormAdd^ f3 = gcnew MyFormAdd(medicines, last, dataGridView1);
	f3->Show();
}
